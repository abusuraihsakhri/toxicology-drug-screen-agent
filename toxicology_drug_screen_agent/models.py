"""
Clinical Data Models & Enums for ToxScreen Sentinel: Immunoassay Cross-Reactivity & Confirmatory LC-MS/MS Agent.
...
class AgentAlert:
    ...
    guideline_citation: str = "AACT / EAPCCT Poisoning Consensus"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
